...
export const Footer: React.FC<FooterProps> = ({ onOpenAdminLogin }) => {
  return (
    <footer className="border-t border-slate-900/90 bg-slate-950 text-slate-400 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-6 border-b border-slate-900">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-slate-950 font-bold shadow-md shadow-amber-500/10">
              <Moon className="w-4 h-4 fill-slate-950 text-slate-950" />
            </div>
            <span className="text-base font-extrabold text-white tracking-tight font-['Outfit']">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 text-xs">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-900/90 border border-slate-800 text-slate-300">
            ...
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-900/90 border border-slate-800 text-slate-300">
              ...
              <span>10 PM – 4:30 AM</span>
            </span>

            {/* Discrete Admin Login Button */}
            <button
              onClick={onOpenAdminLogin}
              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-900 hover:bg-slate-800 text-slate-400 hover:text-amber-300 border border-slate-800 hover:border-slate-700 transition-colors cursor-pointer text-xs ml-1"
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
          <p className="font-medium text-slate-400 text-center sm:text-left">
            © 2026 Allama Mart™. All rights reserved. Designed for campus hostel delivery.
          </p>
          <div className="flex items-center gap-4 text-[11px] text-slate-500">
            <span>100% Sealed Packaged Foods</span>
            <span className="inline-block w-1 h-1 rounded-full bg-slate-700"></span>
            <span>COD & UPI (9749528677@ibl)</span>
          </div>
        </div>
